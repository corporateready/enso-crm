...
import { AddTaskActionsWidgetTypeFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-8/2-8-instance-command-fast-1798900000000-add-task-actions-widget-type';
...
export const INSTANCE_COMMANDS = [
  ...
  AddTaskActionsWidgetTypeFastInstanceCommand,
];
