...
export class PersonRelationshipCreateOnePostQueryHook
  implements WorkspacePostQueryHookInstance
{
  ...
  async execute(
    ...
    // createOne resolver returns the created row (possibly wrapped in an array
    // depending on Twenty internals). Normalize.
